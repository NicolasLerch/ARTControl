...
import { pharmacyCoverageCreateSchema, pharmacyCoverageQuerySchema, pharmacyCoverageUpdateSchema, pharmacyOptionsQuerySchema, } from '../../schemas/pharmacies.js';
...
async function findOrCreateArt(tx, nombre) {
...
async function findOrCreatePharmacy(tx, nombre) {
    const normalizedNombre = normalizeText(nombre);
...
async function findOrCreateBranch(tx, pharmacyId, direccion) {
...
async function resolveCoverageRefs(tx, payload) {
