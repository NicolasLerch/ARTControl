...
function normalizeVademecumInput(value) {
...
const optionalNullableText = (max) => z.string().trim().max(max).optional().nullable();
...
export const vademecumCreateSchema = z.preprocess(normalizeVademecumInput, vademecumBaseSchema);
export const vademecumUpdateSchema = z.preprocess(normalizeVademecumInput, vademecumBaseSchema
    .partial()
