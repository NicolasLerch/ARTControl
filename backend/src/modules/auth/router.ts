...
async function createPersistentSession(req: AuthedRequest, userId: string) {
...
authRouter.post('/setup-2fa', requireAuth, async (req: AuthedRequest, res, next) => {
  try {
...
authRouter.post('/confirm-2fa', requireAuth, async (req: AuthedRequest, res, next) => {
  try {
